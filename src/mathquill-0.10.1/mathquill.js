...
*/
    ...
    _.createLeftOf = function (cursor) {
      if (
        ...
        ((cursor[L] instanceof Variable && cursor[L].isItalic !== false) ||
          (cursor[L] instanceof SupSub && cursor[L][L] instanceof Variable && cursor[L][L].isItalic !== false))
      ) {
  ...
  var Variable = P(Symbol, function (_, super_) {
    ...
    _.text = function () {
      ...
      if (this[L] && !(this[L] instanceof Variable) && !(this[L] instanceof BinaryOperator) && this[L].ctrlSeq !== '\\ ')
        text = '*' + text;
